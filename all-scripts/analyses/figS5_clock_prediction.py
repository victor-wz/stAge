"""Fig S5 -- Clock prediction pipeline (filtering, log1p, StandardScaler/YuGene,
...
distinguishes the Fig S5 panel from Figs 2, 3, S4.

CLI:
    python figS5_clock_prediction.py --rawdata-dir DIR --ncbi-reference-path PATH \\
...
def main():
    ...
    ap.add_argument('--tag', default='figS5')
    args = ap.parse_args()
