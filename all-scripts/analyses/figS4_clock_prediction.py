"""Fig S4 -- Clock prediction pipeline (filtering, log1p, StandardScaler/YuGene,
...
distinguishes the Fig S4 panel from Figs 2, 3, S5.

CLI:
    python figS4_clock_prediction.py --rawdata-dir DIR --ncbi-reference-path PATH \\
...
def main():
    ...
    ap.add_argument('--tag', default='figS4')
    args = ap.parse_args()
